...
namespace NguyenQuangMinh.Tetris
{
    public static class Data
    {
        ...
        { Tetromino.Dot, new Vector2Int[] { new Vector2Int(0, 1) } },
        };
        ...
        private static readonly Vector2Int[,] WallKicksJLOSTZDot = new Vector2Int[,] {
        ...
        public static readonly Dictionary<Tetromino, Vector2Int[,]> WallKicks = new Dictionary<Tetromino, Vector2Int[,]>(){
            ...
            { Tetromino.J, WallKicksJLOSTZDot },
            { Tetromino.L, WallKicksJLOSTZDot },
            { Tetromino.O, WallKicksJLOSTZDot },
            { Tetromino.S, WallKicksJLOSTZDot },
            { Tetromino.T, WallKicksJLOSTZDot },
            { Tetromino.Z, WallKicksJLOSTZDot },
            { Tetromino.Dot, WallKicksJLOSTZDot },
        };
    }
}
